...
def Build_net(shape, dense_block_num, growthRate):
    ...
    def Build_conv3d(x, channel, stride):
        return (Conv3D(channel, kernel_size=(3, 3, 3), padding='same',
    ...
    def Build_Dense_block(name, x):
        ...
        with tf.compat.v1.variable_scope(name) as scope:
            ...
            dense = Build_conv3d(x, growthRate, (1, 1, 1))
    ...
    input_layer = Input(shape=(row, col, 3, 1), name='input')

    x = Build_conv3d(input_layer, channel, (1, 1, 1))
